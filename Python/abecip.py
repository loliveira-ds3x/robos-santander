...
##main
crawlers_main.main(get_type=get_type, etl_type=etl_type, start_url=start_url, html_path=html_path, input_file=input_file,input_file_tab1=input_file_tab1,index_columns=index_columns, column_names=column_names,output_file=output_file,crawler_name=crawler_name,skiped_rows=skiped_rows)