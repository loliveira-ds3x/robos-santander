# -*- coding: utf-8 -*-
"""facebook_ads_v4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qUFkjlv5oWIr7gLXP4JwGYNlaT6K2VBh
...
sdate = date(2020,12,1)   # start date
edate = date(2020,12,2)   # end date
...
for date in dates_list:
  date = str(date)[0:10]
  print("Executando dia "+date)
  count = 0
  for account_id in account_id_list['account_id']:
    print("Executando conta "+str(count)+": "+account_id)
    count = count + 1
    try:
...
df = df_campaignreach_etl.loc[df_campaignreach_etl['campaign_id'] == '23844935694420442']
df
...
'offsite_conversion_custom_actions',
'offsite_conversion_custom_id',
...
'reach_campaign_daily',
'frequency_campaign_daily',
'ad_created_time'
                  ]

final_table_fb = final_table[selected_columns]

final_column_names = ['account_id',
'account_name',
'campaign_id',
'campaign_name',
'publisher_platform',
...
final_table_fb.columns = final_column_names
final_table_fb

final_table_fb.to_csv('facebook_ads.csv',sep='|')